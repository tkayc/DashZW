/**
 * shopHours.js — open/close logic for merchant opening_hours
 *
 * Accepts strings like "8AM - 10PM" or structured objects from the API.
 */
...
/** Normalize API value (string, object, JSON) to a display/parse string. */
...
export function formatOpeningHours(hours) {
  return normalizeOpeningHours(hours) || 'Hours not set';
}
