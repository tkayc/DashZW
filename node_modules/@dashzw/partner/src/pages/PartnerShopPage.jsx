...
import PartnerShopProfile from './PartnerShopProfile';
...
export default function PartnerShopPage() {
  ...
  return <PartnerShopProfile shop={shop} onShopUpdate={() => qc.invalidateQueries({ queryKey: ['partner-shop', user?.email] })} />;
}