...
const SHOPS = [
  ...
  { name: "Pizza Inn", description: "Pizza classics, combo meals and loaded sides", category: "fast_food", image_url: "https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=800&q=80", address: "Oxford Road, Rosebank", city: "Johannesburg", phone: "+27 11 991 1101", lat: -26.1452, lng: 28.0411, rating: 4.6, estimated_delivery_time: "20-30 min", is_open: true, opening_hours: "10:00 AM - 10:30 PM", owner_email: "pizzainn@dashzw.com", approval_status: "approved" },
  ...
  { name: "Bakers Inn", description: "Fresh loaves, pies and sweet pastries baked daily", category: "bakery", image_url: "https://images.unsplash.com/photo-1483695028939-5bb13f8648b0?w=800&q=80", address: "Grant Avenue, Norwood", city: "Johannesburg", phone: "+27 11 992 2202", lat: -26.1572, lng: 28.0735, rating: 4.5, estimated_delivery_time: "15-25 min", is_open: true, opening_hours: "6:00 AM - 7:00 PM", owner_email: "bakersinn@dashzw.com", approval_status: "approved" },
  ...
  { name: "Greenside Grocer", description: "Fresh produce, pantry staples and household basics", category: "grocery", image_url: "https://images.unsplash.com/photo-1488459716781-31db52582fe9?w=800&q=80", address: "Beyers Naude Drive, Greenside", city: "Johannesburg", phone: "+27 11 993 3303", lat: -26.1729, lng: 27.9978, rating: 4.4, estimated_delivery_time: "20-35 min", is_open: true, opening_hours: "7:00 AM - 9:00 PM", owner_email: "greenside@dashzw.com", approval_status: "approved" },
  ...
  { name: "MediQuick Pharmacy", description: "Medicine, wellness and baby care essentials", category: "pharmacy", image_url: "https://images.unsplash.com/photo-1471864190281-a93a3070b6de?w=800&q=80", address: "Louis Botha Avenue, Orange Grove", city: "Johannesburg", phone: "+27 11 994 4404", lat: -26.1613, lng: 28.0758, rating: 4.5, estimated_delivery_time: "20-30 min", is_open: true, opening_hours: "8:00 AM - 9:00 PM", owner_email: "mediquick@dashzw.com", approval_status: "approved" },
  ...
  { name: "Corner Basket", description: "Convenience essentials, snacks and beverages", category: "convenience", image_url: "https://images.unsplash.com/photo-1516594798947-e65505dbb29d?w=800&q=80", address: "Empire Road, Parktown", city: "Johannesburg", phone: "+27 11 995 5505", lat: -26.1829, lng: 28.0262, rating: 4.3, estimated_delivery_time: "15-25 min", is_open: true, opening_hours: "6:00 AM - 11:00 PM", owner_email: "cornerbasket@dashzw.com", approval_status: "approved" },
];
...
const MENU_BY_SHOP = [
  ...
  [{ name: "Pepperoni Pizza (Medium)", description: "Mozzarella, beef pepperoni and tomato sauce", price: 105.0, category: "Pizza", is_popular: true, image_url: "https://images.unsplash.com/photo-1513104890138-7c749659a591?w=400&q=80" }, { name: "BBQ Chicken Pizza", description: "Smoky BBQ chicken with onions and peppers", price: 115.0, category: "Pizza", is_popular: true, image_url: "" }, { name: "Garlic Bread", description: "Toasted garlic bread sticks", price: 28.0, category: "Sides", is_popular: false, image_url: "" }, { name: "2L Soda", description: "Coke, Fanta or Sprite", price: 32.0, category: "Drinks", is_popular: false, image_url: "" }],
  ...
  [{ name: "Family White Loaf", description: "Soft fresh white loaf (sliced)", price: 26.0, category: "Bread", is_popular: true, image_url: "" }, { name: "Steak Pie", description: "Flaky pastry pie with beef filling", price: 30.0, category: "Pastries", is_popular: true, image_url: "" }, { name: "Cream Doughnut", description: "Sugar-coated doughnut with cream filling", price: 16.0, category: "Pastries", is_popular: false, image_url: "" }, { name: "Tea (Regular)", description: "Classic black tea", price: 18.0, category: "Beverages", is_popular: false, image_url: "" }],
  ...
  [{ name: "Tomatoes 1kg", description: "Fresh farm tomatoes", price: 24.0, category: "Produce", is_popular: true, image_url: "" }, { name: "Bananas (6 pack)", description: "Ripe fresh bananas", price: 20.0, category: "Produce", is_popular: true, image_url: "" }, { name: "Cooking Oil 2L", description: "Sunflower cooking oil", price: 62.0, category: "Pantry", is_popular: false, image_url: "" }, { name: "Brown Bread", description: "Whole wheat bread loaf", price: 24.0, category: "Bakery", is_popular: false, image_url: "" }],
  ...
  [{ name: "Cough Syrup", description: "Soothing cough relief syrup", price: 48.0, category: "Medicine", is_popular: true, image_url: "" }, { name: "Allergy Tablets", description: "Daily non-drowsy allergy relief", price: 52.0, category: "Medicine", is_popular: true, image_url: "" }, { name: "Baby Wipes", description: "Sensitive skin baby wipes", price: 36.0, category: "Baby Care", is_popular: false, image_url: "" }],
  ...
  [{ name: "Instant Noodles", description: "Chicken flavour instant noodles", price: 14.0, category: "Snacks", is_popular: true, image_url: "" }, { name: "Chocolate Bar", description: "Milk chocolate bar", price: 10.0, category: "Snacks", is_popular: true, image_url: "" }, { name: "Orange Soda 440ml", description: "Chilled fizzy orange drink", price: 14.0, category: "Drinks", is_popular: false, image_url: "" }],
];
...
export function seedDatabase() {
  const SEED_VERSION = 'dashzw_v11_courier';
  ...
  const DRIVER_PROFILES = [
    { email: 'driver1@dashzw.com', full_name: 'Tendai Moyo', vehicle_type: 'motorbike', lat: -26.1073, lng: 28.0570, rating: 4.9 },
    { email: 'driver2@dashzw.com', full_name: 'Chido Ncube', vehicle_type: 'car', lat: -26.1465, lng: 28.0427, rating: 4.7 },
    { email: 'driver3@dashzw.com', full_name: 'Farai Dube', vehicle_type: 'van', lat: -26.1950, lng: 28.0410, rating: 4.8 },
  ];
  const driverProfileRecords = DRIVER_PROFILES.map((driver, idx) => ({
    id: `drv${idx + 1}_${(now.getTime() + idx).toString(36)}`,
    email: driver.email,
  ...
  saveCollection('DriverProfile', driverProfileRecords);

  ['Order', 'Review', 'Promotion', 'Wallet', 'Transaction', 'Notification'].forEach((k) =>
    saveCollection(k, [])
  );
